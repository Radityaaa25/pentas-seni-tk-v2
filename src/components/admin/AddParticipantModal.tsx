export const AddParticipantModal = ({ 
  ...
  setAddData: (data: { name: string; class: string }) => void,
  onAdd: () => void 
}) => {
      ...
      <div className="bg-[#fff8e1] p-8 rounded-3xl w-full max-w-md shadow-2xl transform transition-all scale-100 border-4 border-[#5d4037]">
        ...
        <div className="space-y-5">
          ...
          <div className="flex gap-3 mt-8">
            ...
            <button onClick={onAdd} className="flex-1 py-4 bg-green-700 text-white font-black rounded-xl hover:bg-green-800 shadow-lg shadow-green-700/30 transition-colors">Simpan & Daftar</button>
          </div>
        </div>
      </div>
    </div>
