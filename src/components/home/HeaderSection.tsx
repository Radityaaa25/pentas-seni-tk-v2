export const HeaderSection = ({ isHidden }: { isHidden: boolean }) => {
  return (
    <div
      ...
      <div className="relative w-85 h-25 mt-32 -mb-4 md:-mt-32 md:w-150 md:h-28 filter drop-shadow-md">
      ...
      <div className="relative w-90 h-16 -mt-3 md:mb-3 md:w-162.5 md:h-24 filter drop-shadow-md">
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img
          src="/Teks2.png"
          alt="Keterangan"
