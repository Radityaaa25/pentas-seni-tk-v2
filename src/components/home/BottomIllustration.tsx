...
export const BottomIllustration = ({ isHidden }: { isHidden: boolean }) => {
  return (
    <div className={`relative w-full max-w-md flex justify-center gap-55 items-end px-6 -mt-35 md:-mt-40 z-20 pointer-events-none animate-fade-in-up delay-500 shrink-0 ${!isHidden ? 'flex' : 'hidden'}`}>
